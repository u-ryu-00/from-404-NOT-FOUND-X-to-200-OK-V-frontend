...
Scenario('(옵션 선택 X + 로그인 X) 장바구니에 담기 버튼을 누른 경우', ({ I }) => {
  // Given
...
Scenario('(옵션 선택 O + 로그인 X) 장바구니에 담기 버튼을 누른 경우', ({ I }) => {
  // Given
  I.amOnPage('/products/1');
  // 옵션을 선택함.
...
Scenario('(옵션 선택 X + 로그인 O) 장바구니에 담기 버튼을 누른 경우', ({ I }) => {
  // Given
  // 로그인 함.
  I.amOnPage('/products/1');
  // 옵션 선택을 하지 않음.
...
Scenario('(옵션 선택 O + 로그인 O) 장바구니에 담기 버튼을 누른 경우', ({ I }) => {
  // Given
  // 로그인 함.
  I.amOnPage('/products/1');
  // 옵션을 선택함.
